...
export function HeroSection({ name, profileImage = "/images/profilePic2(Riya).jpeg" }: HeroSectionProps) {
  ...
  return (
    <section className="min-h-2.5 md:min-h-120 mt-12 md:mt-0 flex items-center justify-center">
          ...
          <div className="md:col-span-1 flex">
            <div className="relative w-96 h-52 md:w-[50%] md:h-[50%]">
              ...
              <img
                ...
                alt={name}
                className={`hidden md:block relative w-20 h-30 rounded-2xl object-cover shadow-md shadow-pink-700/25 transition-all duration-700 ease-out  ${
              ...
              <div className="space-y-4">
                <div className="w-full md:w-96 flex justify-between gap-20 pb-2 md:mt-4 animate-fadeInUp border-b border-[#919191]/25 md:py-4">
                  ...
                  <ul className="w-80 flex flex-col items-start mt-2 border-white/50">
                    <li className="text-sm font-light text-[#919191]">Full-Stack Developer</li>
                    ...
                    <li className="text-sm font-light text-[#919191]">5+ Years Experience</li>
                  </ul>
                </div>
