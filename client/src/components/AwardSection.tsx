...
export function AwardSection() {
  ...
  return (
    <section id="awards" className="w-full mx-auto mb-8 md:mb-12 py-4 px-4 md:py-2 md:my-8 sm:px-6">
      <div className="container max-w-2xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between md:items-start mb-8 md:mb-0">
          <AnimatedSection className="md:sticky md:top-15 self-start">
            <h2 className="text-3xl sm:text-4xl md:text-4xl md:font-normal mb-6 md:mb-0">Awards</h2>
          </AnimatedSection>
