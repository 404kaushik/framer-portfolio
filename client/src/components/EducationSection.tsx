...
export function EducationSection({ items }: EducationSectionProps) {
  ...
  return (
    <section id="education" className="w-full mx-auto py-12 md:py-20 px-4 sm:px-6">
      <div className="container max-w-2xl mx-auto">
        {/* Header Section */}
        <div className="flex flex-col md:flex-row justify-between md:items-start mb-8 md:mb-0">
          <AnimatedSection>
            <h2 className="text-3xl sm:text-4xl md:text-2xl font-light mb-6 md:mb-0">Education</h2>
          </AnimatedSection>
